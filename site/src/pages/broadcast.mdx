...
**Note**: This feature was introduced because people could not anonymously respond to
...
PureMOOt managers can ban users from broadcasting in a
channel if it results in abuse/spam/etc.

<Command name="/pmmanager bban" admin={true}>
Ban anonymous broadcasting on this channel.
</Command>
<Command name="/pmmanager ballow" admin={true}>
Allow anonymous broadcasting on this channel.
</Command>
<Command name="/pmmanager bpermitted">
See if broadcasting is permitted (non-admin)
</Command>
